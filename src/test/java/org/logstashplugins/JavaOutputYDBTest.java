...
public class JavaOutputYDBTest {
    ...
    private static Configuration getConfiguration() {
        ...
        configValues.put(JavaOutputYDB.CONNECTION_STRING.name(), connectionString);
        configValues.put(JavaOutputYDB.TABLE_NAME.name(), tableName);
        configValues.put(JavaOutputYDB.SA_KEY_FILE.name(), saKeyFile);
        configValues.put(JavaOutputYDB.COLUMNS.name(), column);
    ...
    public void testJavaOutputExample() {
        ...
        JavaOutputYDB output = new JavaOutputYDB("id", config, null, baos);
